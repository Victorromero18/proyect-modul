                            ...
                            <div id="resumen-trimestral-content" style="display:none;">
                                <table style="width:100%; border-collapse:collapse; border:2px solid #3498db; font-family:Arial, sans-serif; font-size:10px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="background:#ffffff;"><td style="padding:5px; border:1px solid #3498db;">26I</td><td style="padding:5px; border:1px solid #3498db;">1</td><td style="padding:5px; border:1px solid #3498db;">30</td><td style="padding:5px; border:1px solid #3498db;">0</td><td style="padding:5px; border:1px solid #3498db;">0</td><td style="padding:5px; border:1px solid #3498db;">0</td><td style="padding:5px; border:1px solid #3498db;">0</td><td style="padding:5px; border:1px solid #3498db;">0</td><td style="padding:5px; border:1px solid #3498db;">0</td><td style="padding:5px; border:1px solid #3498db;">1</td><td style="padding:5px; border:1px solid #3498db;">6</td><td style="padding:5px; border:1px solid #3498db;">223</td><td style="padding:5px; border:1px solid #3498db;">49</td></tr>
                                    </tbody>
                                </table>
                            </div>
